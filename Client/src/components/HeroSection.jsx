...
const HeroSection = () => {
  ...
  const handleBookAppointment = () => {
    const section = document.querySelector("#bookappointment");
  ...
  return (
    <section
      id="hero"
      className="relative bg-[#0086AD] text-white min-h-screen flex items-center py-12 px-4 md:px-10 lg:px-15"
    >
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center w-full">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <button
              ...
              className="bg-white text-[#0086AD] font-semibold px-5 py-2 rounded-full flex items-center gap-2 transition duration-300 ease-in-out hover:bg-[#0086AD] hover:text-white hover:shadow-lg hover:scale-105"
            >
              <Calendar size={18} /> BOOK APPOINTMENT
            </button>
            <a
              href="tel:9850318850"
              className="bg-gray-100 text-[#0086AD] font-semibold px-5 py-2 rounded-full flex items-center gap-2 transition duration-300 ease-in-out hover:bg-[#0086AD] hover:text-white hover:shadow-lg hover:scale-105"
            >
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <a
              href="https://maps.app.goo.gl/qL3bJgx5PURNDUUf8"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#047799] px-5 py-3 rounded-xl flex items-center gap-3 w-fit transition duration-300 hover:shadow-lg hover:scale-105"
            >
              <MapPin size={20} />
              <div>
          ...
          {/* Emergency Call Card (Moved Here) */}
        ...
        >
          ...
          <div className="bg-[#047799] p-4 rounded-2xl text-center w-full max-w-sm transition duration-300 hover:shadow-2xl hover:scale-105">
            <img
              src={doctorImage}
              alt="Dr. Shivkumar Patel - General & Family Physician in Nagpur"
            ...
            <p className="text-sm text-gray-200 italic px-4">
              "Committed to delivering exceptional healthcare with compassion and
              expertise for every patient and family"
            </p>
          </div>
